...
**Music Player H** یک پخش‌کننده موسیقی و ویدئوی حرفه‌ای و مدرن برای ویندوز است که با فناوری WPF و C# توسعه یافته است. این برنامه با طراحی کاربرپسند و امکانات پیشرفته، تجربه‌ای بی‌نظیر از پخش مدیا را ارائه می‌دهد.
...
- پشتیبانی از فایل‌های ویدئویی به عنوان صوتی
...
- استریم به TrafficWatch Dashboard
- پشتیبانی از پروتکل‌های UPnP
- سرور داخلی HTTP برای استریم
